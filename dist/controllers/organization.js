...
exports.addTherapistInOrganization = exports.deleteTherapistFromOrganization = exports.getDetailsByCode = exports.verifyCode = exports.deleteOrganization = exports.updateOrganization = exports.createOrganization = exports.getAllOrganizations = void 0;
...
const getAllOrganizations = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let organizations;
        if (user.role === "admin") {
            organizations = yield Organization_1.default.find({});
        }
        else if (user.role === "therapist") {
            organizations = yield Organization_1.default.find({ therapists: userId });
        }
        else {
            return res.status(403).json({
                Status: "failure",
        ...
        const organizationsWithTherapists = yield Promise.all(organizations.map((org) => __awaiter(void 0, void 0, void 0, function* () {
            // Fetch therapist details
            const therapists = yield User_1.default.find({ _id: { $in: org.therapists } }, { _id: 1, name: 1 }).lean();
            const clientCount = yield User_1.default.countDocuments({
            ...
            return Object.assign(Object.assign({}, org.toObject()), { therapists: formattedTherapists, users: clientCount });
        })));
        return res
            .status(200)
...
const createOrganization = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user_Id;
    const { name, location, code, country, description, logo, therapists } = req.body;
...
const updateOrganization = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user_Id;
    const { id, name, location, code, country, description, logo, therapists } = req.body;
    if (!id) {
        return res.status(400).json({
            Status: "failure",
            Error: {
...
const deleteOrganization = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield Organization_1.default.findByIdAndDelete(id);
...
const verifyCode = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const organization = yield Organization_1.default.findOne({ code });
        if (!organization) {
            return res.status(403).json({
                Status: "failure",
                Error: {
...
const getDetailsByCode = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getDetailsByCode = getDetailsByCode;
const deleteTherapistFromOrganization = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user_Id;
    const { organizationId, therapistId } = req.params;
    try {
        // Check if user is an admin
        const user = yield User_1.default.findById(userId).select("role");
        ...
        organization.therapists = organization.therapists.filter((id) => id.toString() !== therapistId);
...
exports.deleteTherapistFromOrganization = deleteTherapistFromOrganization;
const addTherapistInOrganization = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const validTherapists = yield User_1.default.find({
            _id: { $in: therapistIds },
            role: "therapist",
        }).select("_id");
        // Extract valid therapist IDs
        const validTherapistIds = validTherapists.map((therapist) => String(therapist._id));
        // Find invalid therapist IDs
        const invalidTherapistIds = therapistIds.filter((id) => !validTherapistIds.includes(id));
        if (invalidTherapistIds.length > 0) {
            return res.status(400).json({
                status: "failure",
                error: {
                    message: "Some provided therapist IDs are invalid or do not belong to therapists.",
        ...
        const newTherapists = validTherapistIds.filter((id) => !organization.therapists.includes(id));
        if (newTherapists.length === 0) {
            return res.status(400).json({
                status: "failure",
                error: {
                    message: "All therapists are already associated with this organization.",
                    name: "ValidationError",
                },
            });
        }
...
exports.addTherapistInOrganization = addTherapistInOrganization;
